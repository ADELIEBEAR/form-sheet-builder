import { ChartBar, Files, FolderOpen } from '@phosphor-icons/react'
  ...
  return (
    <aside className="workspace-sidebar">
      <nav aria-label="작업 공간 메뉴">
        ...
        <Link className={active === 'responses' ? 'active' : ''} to="/responses"><ChartBar weight={active === 'responses' ? 'fill' : 'regular'} /> 전체 응답</Link>
      </nav>
