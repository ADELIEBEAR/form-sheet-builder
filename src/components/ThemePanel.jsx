...
export default function ThemePanel({ project, projectId, onChange }) {
  ...
  return (
    <div className="inspector-panel">
      ...
      <label className="studio-control"><span>모서리 둥글기</span><input type="range" min="0" max="28" step="2" value={theme.radius ?? 18} onChange={(event) => patch({ radius: Number(event.target.value) })} /><small>{theme.radius ?? 18}px</small></label>
