  ...
  return (
    <main className="new-landing">
      <nav className="landing-bar">
        ...
        <button className="landing-login" type="button" onClick={() => login()}>관리자 로그인</button>
      </nav>
      <section className="landing-hero">
        <div className="landing-copy">
          ...
          <button className="landing-cta" type="button" onClick={() => login('/workspace')}><GoogleLogo weight="bold" /> Google로 관리자 로그인 <ArrowRight weight="bold" /></button>
